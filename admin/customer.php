...
/*
    ...
    <?= tep_draw_form('customers', 'customers.php', tep_get_all_get_params(array('action')) . 'action=update', 'post', 'onsubmit="return check_form();"') ?>
      <?= tep_draw_hidden_field('default_address_id', $cInfo->customers_default_address_id) ?>
