...
define('HEADING_TITLE', 'Country Zones');
...
define('TEXT_INFO_HEADING_REMOVE_ALL_ZONES', 'Delete all Zones from %s');
define('TEXT_INFO_DELETE_ALL_INTRO', 'Are you sure you want to delete all zones from %s?');
define('TEXT_INFO_HEADING_NEW_ZONE_IN_COUNTRY', 'New Zone in %s');
define('TEXT_INFO_HEADING_NEW_ZONE_COUNTRY', 'New Zones Country');
define('TEXT_INFO_HEADING_EDIT_ZONE', 'Edit Zone');
define('TEXT_INFO_HEADING_DELETE_ZONE', 'Delete Zone');

define('MESSAGE_ZONE_ADDED', 'Zone \'%s\' added correctly.');
define('MESSAGE_ZONE_DELETED', 'Zone deleted correctly.');
define('MESSAGE_ZONES_DELETED', 'Zones from \'%s\' deleted correctly.');
?>