  ...
  class product_general {
    ...
    function __construct($id=0) {
      ...
      if ( defined($this->cfg_key . 'STATUS')) {
        ...
        $this->size = constant($this->cfg_key . 'SIZE');
    ...
    function get_value ($id) {
      global $product;
      if ($id > 0) {
        return $product->data['products_id'];
      }
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Content Width', '" . $this->cfg_key . 'SIZE' . "', 'Left', 'Size', '6', '1', 'tep_cfg_select_option(array(\'Left\', \'Right\', \'Center\'), ', now())");
    }
