<?php
  ...
  class languages_installed_image {
    var $code;
    var $group;
    var $title;
    var $description;
    ...
    function get_value ($code) {
      ...
      if ($code != '0') {
        return tep_image(tep_catalog_href_link('includes/languages/' . $languages_setup->installed[$code]['directory'] . '/images/' . $languages_setup->installed[$code]['image'], '', 'SSL'), $languages_setup->installed[$code]['name']);
      }
    }
