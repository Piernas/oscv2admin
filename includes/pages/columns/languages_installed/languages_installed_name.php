<?php
  ...
  class languages_installed_name {
    var $code;
    var $group;
    var $title;
    var $description;
    ...
    function __construct($code = 0) {
      ...
      $this->title = 'Installed languages'; // $this->cfg_key . 'NAME'
      $this->description = 'Shows languages Name'; // $this->cfg_key . 'DESCRIPTION'
    ...
    function get_value ($code) {
      ...
      if ($code != '0') {
        ...
        return $languages_setup->installed[$code]['name'] . $style;
      }
    }
