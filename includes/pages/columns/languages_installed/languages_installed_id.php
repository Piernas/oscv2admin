<?php
  ...
  class languages_installed_id {
    ...
    function __construct($code = 0) {
      ...
      $this->title = 'Id'; // $this->cfg_key . 'NAME'
      $this->description = 'Shows languages id'; // $this->cfg_key . 'DESCRIPTION'
    ...
    function get_value ($code) {
      ...
      if ($code != '0') {
        return $languages_setup->installed[$code]['id'];
      }
    }
