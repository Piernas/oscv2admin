<?php
  ...
  class customers_account_created {
    var $code;
    var $group;
    var $title;
    var $description;
    ...
    function get_value ($id) {
      global $customer;
      if ($id > 0) {
        return tep_date_short($customer->customer_info['customers_info_date_account_created']);
      }
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', '" . $this->cfg_key . 'SORT_ORDER' . "', '4', 'Sort order of display. Lowest is displayed last.', '6', '0', now())");
