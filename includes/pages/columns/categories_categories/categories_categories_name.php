<?php
  ...
  class categories_categories_name {
    var $code;
    var $group;
    var $title;
    var $description;
    ...
    function __construct($id=0) {
      global $category, $languages_id, $category_name;
      ...
      // Localize:
      if (isset ($category)) {
        $this->title = (!isset($_GET['search'])) ? sprintf (TABLE_HEADING_CATEGORIES_UNDER, $category_name) : TABLE_HEADING_CATEGORIES_MATCHING; 
      } else {
    ...
    function get_value ($id) {
      global $category, $languages_id;
      if ($id > 0) {
//        return $category->description[$languages_id]['categories_name'];
