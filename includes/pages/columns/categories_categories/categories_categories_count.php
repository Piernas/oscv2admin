<?php
  ...
  class categories_categories_count {
    var $code;
    var $group;
    var $title;
    var $description;
...
//        return $category->info[$languages_id]['name'];
        return '<span class="badge badge-pill badge-' . $warning_empty_category . '">' . $category->count_subcategories() . ' / ' . $category->count_products() . '</span>';
