<?php
  ...
  class languages_uninstalled_image {
    var $code;
    var $group;
    var $title;
    var $description;
    ...
    function __construct($code = 0) {
      ...
      $this->title = 'Image'; // $this->cfg_key . 'NAME'
      $this->description = 'Shows languages Image'; // $this->cfg_key . 'DESCRIPTION'
    ...
    function get_value ($code) {
      ...
      if ($code != '0') {
        return tep_image(tep_catalog_href_link('includes/languages/' . $languages_setup->uninstalled[$code]['directory'] . '/images/' . $languages_setup->uninstalled[$code]['image'], '', 'SSL'), $languages_setup->uninstalled[$code]['name']);
      }
    }
