<?php
  ...
  class customers_info {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="customer-edit-' . $customer->customer_id . '" href="' . tep_href_link('customer.php',  tep_get_all_get_params(array('cID', 'action')) . 'cID=' . $customer->customer_id . '&action=info') . '"><i class="fas fa-info-circle fa-lg text-info"></i></a>' . PHP_EOL;
      }
      return $button;
    }
