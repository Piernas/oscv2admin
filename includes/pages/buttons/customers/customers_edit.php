<?php
  ...
  class customers_edit {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="customer-edit-' . $customer->customer_id . '" href="' . tep_href_link('customer.php',  tep_get_all_get_params(array('cID', 'action')) . 'cID=' . $customer->customer_id . '&action=edit') . '"><i class="fas fa-edit fa-lg text-info"></i></a>' . PHP_EOL;
      }
      return $button;
    }
