<?php
  ...
  class customers_delete {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="customer-delete-' . $customer->customer_id . '" href="' . tep_href_link('customers.php', tep_get_all_get_params(array('cID', 'action')) . 'cID=' . $customer->customer_id . '&action=customers_delete') . '"><i class="fas fa-trash fa-lg text-danger"></i></a>' . PHP_EOL;
      }
      return $button;
    }
