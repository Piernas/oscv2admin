<?php
  ...
  class reviews_delete {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="review-delete-' . $review->reviews_id . '" href="' . tep_href_link('review.php',  tep_get_all_get_params(array('rID', 'action')) . 'rID=' . $review->reviews_id . '&action=reviews_delete') . '"><i class="fas fa-trash fa-lg text-danger"></i></a>' . PHP_EOL;
      }
      return $button;
    }
