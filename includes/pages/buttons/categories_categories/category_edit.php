...
//        $this->value = $this->get_value($id);
    ...
    function get_value ($id) {
      ...
      if ($id > 0) {
        ...
        $button = '                  <a href="' . tep_href_link('category.php', 'cPath=' . $cPath . '&categories_id=' . $category->categories_id . '&action=edit_category') . '"><i class="fas fa-edit fa-lg text-primary"></i></a>' . PHP_EOL;
