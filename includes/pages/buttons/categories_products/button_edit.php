<?php
  ...
  class button_edit {
    ...
    function get_value ($id) {
      ...
      global $product, $cPath;
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="product-edit-<?=$product->products_id ?>" href="' . tep_href_link('product.php', 'cPath=' . $cPath . '&pID=' . $product->products_id . '&action=new_product') . '"><i class="fas fa-edit fa-lg text-primary"></i></a>' . PHP_EOL;
      }
      return $button;
    }
