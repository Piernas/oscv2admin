<?php
  ...
  class orders_invoice {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="order-edit-' . $order->info['orders_id'] . '" href="' . tep_href_link('invoice.php', 'oID=' . $order->info['orders_id']) . '" target="_blank"' . '><i class="fas fa-file-invoice fa-lg text-primary"></i></a>' . PHP_EOL;
      }
      return $button;
    }
