<?php
  ...
  class orders_delete {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="order-edit-' . $order->info['orders_id'] . '" href="' . tep_href_link('orders.php',tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $order->info['orders_id'] . '&action=delete') . '"><i class="fas fa-trash fa-lg text-danger"></i></a>' . PHP_EOL;
      }
      return $button;
    }
