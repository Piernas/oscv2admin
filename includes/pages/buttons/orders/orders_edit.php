<?php
  ...
  class orders_edit {
    ...
    function get_value ($id) {
      ...
      $button ="";
      if ($id > 0) {
        $button = '                  <a id="order-edit-' . $order->info['orders_id'] . '" href="' . tep_href_link('order.php',  tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $order->info['orders_id'] . '&action=edit') . '"><i class="fas fa-info-circle fa-lg text-info"></i></a>' . PHP_EOL;
      }
      return $button;
    }
